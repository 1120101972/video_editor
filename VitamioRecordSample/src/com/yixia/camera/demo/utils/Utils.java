...
//	}
	...
	public static void toast(Context c, String msg, boolean show, int duration,
		...
		if (!show)
			return;
		VCameraDemoApplication.toastMgr.builder.display(msg, duration,position,yOffset);
	}
...
//			UtilsLog.e("congjianfei", "启动的服务有哪些呢？"+i+serviceList.get(i).service.getClassName());
...
//		// urlStr.hashCode();
//		String path = SoufunConstants.PIC_CACHE_DIR_PATH + File.separator + urlStr.hashCode();
//		File file = new File(path);
//		if (!file.getParentFile().exists()) {
//			file.getParentFile().mkdirs();
//		}
...
//			return null;
//		}
////		String path = SoufunConstants.PIC_DIR + File.separator+ urlStr.hashCode();
//		String path = SoufunConstants.PIC_CACHE_DIR_PATH + File.separator+ urlStr.hashCode();
//
