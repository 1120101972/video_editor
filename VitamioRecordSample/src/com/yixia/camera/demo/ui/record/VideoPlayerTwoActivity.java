 ...
 * 
 */
public class VideoPlayerTwoActivity extends BaseActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mPath = "http://10.1.112.123:5080/live/vedio/hi.mp4";
		Toast.makeText(VideoPlayerTwoActivity.this, mPath, 0).show();
				...
				.setOnVideoSizeChangedListener(new OnVideoSizeChangedListener() {
					...
					public void onVideoSizeChanged(MediaPlayer arg0, int arg1,
						...
						mVideoView.getLayoutParams().height = (int) (DeviceUtils
								.getScreenWidth(VideoPlayerTwoActivity.this) * radio);
		...
		public void handleMessage(Message msg) {
			...
			try {
				...
				if (object.getBoolean("success")) {
					Toast.makeText(VideoPlayerTwoActivity.this, "上传成功", 0)
							.show();
					mPath = "http://10.1.112.123:6060/vedio/"
							+ object.getString("message");
					mVideoView.setVideoPath(mPath);

				} else {
					Toast.makeText(VideoPlayerTwoActivity.this, "上传成功失败，请重新上传",
							0).show();
